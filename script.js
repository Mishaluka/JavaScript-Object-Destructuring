...
//
//End of the material for the assignments
//
...
//Recive 2 retern values from a function 
...
//
//Destructuring Arrays Challanges 
//
...
// renaming object variable names
const { name: restaurantName, openingHours: hours, categories: tags } = restaurant;
console.log(restaurantName, hours, tags);


// setting default value , takealook
const { menu = [], starterMenu: starters = [] } = restaurant;
console.log(menu, starters);

//Mutating variables while we structuring the object 
let a = 111;
let b = 999;
const obj = { a: 23, b: 7, c: 14 };
//To let it happened we need wrap the structure assignment into "( )" then it will override
({ a, b } = obj);
console.log(a, b);

//Nested object destructury
...
//2.2  
// Each book object has the keywords property. Destructure the first book object from the books array into a variable called newTags. 
...
/*Write a function called printBookInfo that has three parameters called title, author and year. 
  ...
  code1: printBookInfo({ title: 'Algorithms', author: 'Robert Sedgewick', year: '2011' });
  code2: printBookInfo({ title: 'Algorithms', author: 'Robert Sedgewick' });
*/
